...
public class DriveTrain extends Mechanism {
    ...
    DCMotorWithEncoderHandler frontL = new DCMotorWithEncoderHandler ("frontL", false, true);
    DCMotorWithEncoderHandler frontR = new DCMotorWithEncoderHandler ("frontR", true, true);
    DCMotorWithEncoderHandler backL = new DCMotorWithEncoderHandler ("backL", false, true);
    DCMotorWithEncoderHandler backR = new DCMotorWithEncoderHandler ("backR", true, true);
